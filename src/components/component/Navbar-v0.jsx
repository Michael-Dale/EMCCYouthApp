...
export function NavbarV0() {
  return (
    (<div
      className="flex items-center justify-between rounded-full bg-zinc-800 p-2 max-w-max">
      ...
      <div className="flex space-x-2 border-r border-zinc-600 px-3">
        ...
        <div className="relative">
          <img
            ...
            style={{ aspectRatio: "32/32", objectFit: "cover" }} />
          <span
            className="absolute top-0 left-0 flex items-center justify-center w-full h-full text-white text-xs font-bold">
            9+
          </span>
        </div>
      </div>
